...
- 2023 - Joined [phospho (YC W24)](https://phospho.ai), an AI startup, as a **Founding Engineer** (first employee). I accelerate the adoption of the latest AI technologies in Paris and San Francisco. Most notably, we built [the open source platform phosphobot](https://docs.phospho.ai/welcome) to let you train special AI models ([VLA](https://en.wikipedia.org/wiki/Vision-language-action_model)) that control robots.
